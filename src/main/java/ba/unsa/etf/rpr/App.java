...
public class App
{
     ...
     * @param args first element should be expression in form of a String
     * @throws RuntimeException if expression is invalid (valid expression has a space between every character)
     */
